...
const Growth = () => {
  return (
    ...
    >
      {/* ✅ LEFT SECTION (Text) */}
      <div className="w-full  md:w-full lg:w-1/2 flex flex-col lg:justify-center md:pt-12
       justify-center text-center md:text-center space-y-4 md:space-y-2 sm:space-y-6">
